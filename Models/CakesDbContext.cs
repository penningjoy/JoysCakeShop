...
{
    public class CakesDbContext : IdentityDbContext<IdentityUser> // :DbContext ( Replaced by .NET Core Idenitity for API Authentication. Do Database migration for the change to effect.)
    {
       // private DbContextOptions _contextOptions;
        ...
        /*  -- To be removed later --- 
         *  This is to seed some data to get started */
